...
public abstract class Hilt_MapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MapFragment_GeneratedInjector) this.generatedComponent()).injectMapFragment(UnsafeCasts.<MapFragment>unsafeCast(this));
    }
  }
