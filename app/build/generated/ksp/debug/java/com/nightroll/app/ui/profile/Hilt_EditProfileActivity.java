...
public abstract class Hilt_EditProfileActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditProfileActivity() {
    super();
    _initHiltInternal();
  }

  Hilt_EditProfileActivity(int p0) {
    super(p0);
    _initHiltInternal();
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditProfileActivity_GeneratedInjector) this.generatedComponent()).injectEditProfileActivity(UnsafeCasts.<EditProfileActivity>unsafeCast(this));
    }
  }
