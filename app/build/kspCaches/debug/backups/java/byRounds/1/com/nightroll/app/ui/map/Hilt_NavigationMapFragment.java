...
public abstract class Hilt_NavigationMapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NavigationMapFragment() {
    super();
  }

  Hilt_NavigationMapFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NavigationMapFragment_GeneratedInjector) this.generatedComponent()).injectNavigationMapFragment(UnsafeCasts.<NavigationMapFragment>unsafeCast(this));
    }
  }
